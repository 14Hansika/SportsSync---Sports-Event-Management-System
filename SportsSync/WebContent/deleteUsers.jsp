...
<%
  try {
    ...
    PreparedStatement ps = con.prepareStatement("delete from players where pid=?");
    ps.setString(1, pid);
...
<div class="container mt-5 text-center">
  <div class="alert alert-warning" role="alert">
    ...
    <hr>
    <p class="mb-0">Please return to the <a href="viewUsers.jsp" class="alert-link">Officers Page</a>.</p>
  </div>
</div>
